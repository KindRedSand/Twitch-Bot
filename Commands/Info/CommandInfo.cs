...
namespace TwitchBot.Commands
{
    ...
    public class CommandInfo
    {
        ...
        {
            Module.Service.Log($"Executing {GetLogText(context)}", RazorwingGL.Framework.Logging.LoggingTarget.Runtime, RazorwingGL.Framework.Logging.LogLevel.Debug);
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                Module.Service.Log(wrappedEx.Message, RazorwingGL.Framework.Logging.LoggingTarget.Runtime, RazorwingGL.Framework.Logging.LogLevel.Error);
                Module.Service.Log(wrappedEx.StackTrace, RazorwingGL.Framework.Logging.LoggingTarget.Stacktrace, RazorwingGL.Framework.Logging.LogLevel.Error);
            ...
            {
                Module.Service.Log($"Executed {GetLogText(context)}");
            }
        }
