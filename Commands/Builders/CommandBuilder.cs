...
namespace TwitchBot.Commands.Builders
{
    public class CommandBuilder
    {
        ...
        internal CommandBuilder(ModuleBuilder module, string primaryAlias, Func<ICommandContext, object[], IServiceProvider, CommandInfo, Task> callback)
            : this(module)
        {
            TwitchBot.Reflection.Preconditions.NotNull(primaryAlias, nameof(primaryAlias));
            Reflection.Preconditions.NotNull(callback, nameof(callback));
