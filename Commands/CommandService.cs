...
using TwitchBot.Commands.Readers;
...
namespace TwitchBot.Commands
{
    public class CommandService
    {
        ...
        //internal readonly Logger _cmdLogger; //We use static version, no more needed.
        ...
        public SearchResult Search(ICommandContext context, int argPos)
            => Search(context, context.Message.Substring(argPos));
        public SearchResult Search(ICommandContext context, string input)
        {
            ...
            if (matches.Length > 0)
                ...
                return SearchResult.FromError(CommandError.UnknownCommand, "Комманда не найдена.");
        }
        ...
        public Task<IResult> ExecuteAsync(ICommandContext context, int argPos, IServiceProvider services, MultiMatchHandling multiMatchHandling = MultiMatchHandling.Exception)
            => ExecuteAsync(context, context.Message.Substring(argPos), services, multiMatchHandling);
