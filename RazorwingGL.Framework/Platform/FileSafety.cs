...
namespace RazorwingGL.Framework.IO.File
{
    public static class FileSafety
    {
        ...
        //                        return FileType.Zip;
        //#if P2P
        //                    case "RazorwingGLmagnet":
        //                        return FileType.RazorwingGLMagnet;
        //#endif
        //                    case "osc":
        //                        return FileType.RazorwingGLM; //RazorwingGL!stream
        //                    case "ogg":
        //                    case "mp3":
        ...
        {
            string directory = Path.Combine(Path.GetTempPath(), @"RazorwingGL!");
